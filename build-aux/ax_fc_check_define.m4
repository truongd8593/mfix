# ===========================================================================
#    http://www.gnu.org/software/autoconf-archive/ax_fc_check_define.html
# ===========================================================================
#
# SYNOPSIS
#
...
#   defined.
#
#   If the symbol is defined it's value will be stored in the variable
#   ax_cv_fc_defined_<symbol>.
#
...
AS_VAR_PUSHDEF([ax_var],[ax_cv_fc_defined_$1])dnl
AC_LANG_PUSH([Fortran])
ax_fc_check_define_srcext_save=$ac_fc_srcext
AC_FC_PP_SRCEXT([F])
AC_CACHE_CHECK([whether $1 is defined], [ax_var],
  AC_RUN_IFELSE([AC_LANG_PROGRAM([], [[
    ...
    [AS_VAR_SET([ax_var], $(cat ./conftest.out))],
