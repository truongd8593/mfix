...
!Strain rate tensor
      Allocate(  D_s11 (DIMENSION_3, DIMENSION_M) )
      Allocate(  D_s22 (DIMENSION_3, DIMENSION_M) )
      Allocate(  D_s12 (DIMENSION_3, DIMENSION_M) )
      Allocate(  vort_s12 (DIMENSION_3, DIMENSION_M) )
      IF(.NOT. NO_K) THEN
        Allocate(  D_s33 (DIMENSION_3, DIMENSION_M) )
        Allocate(  D_s13 (DIMENSION_3, DIMENSION_M) )
        Allocate(  D_s23 (DIMENSION_3, DIMENSION_M) )
      Allocate(  vort_s13 (DIMENSION_3, DIMENSION_M) )
      Allocate(  vort_s23 (DIMENSION_3, DIMENSION_M) )
      ENDIF
