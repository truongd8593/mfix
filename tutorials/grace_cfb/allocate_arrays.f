...
!drag
      ...
      Allocate(  U_dx(DIMENSION_3))
      Allocate(  U_dy(DIMENSION_3))
      Allocate(  U_dz(DIMENSION_3))
...
!scalars
	...
	Allocate(  Scalar_c_O (DIMENSION_3,  DIMENSION_Scalar) )
	Allocate(  Scalar_p_O (DIMENSION_3,  DIMENSION_Scalar) )
