...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(1)
      !Pg!
        MMS_Function = pg0 + pgx*(1 - yt)**2*Cos(2*Pi*(xt + yt)) 
      CASE(2)
      !Ug!
        MMS_Function = ug0 + 3*vgy*xt*(1 - yt)**2 
      CASE(3)
      !Vg!
        MMS_Function = vg0 + vgy*(1 - yt)**3
      CASE(4)
      !Wg!
        MMS_Function = ZERO
      Case(5)
...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(2)
      !ugsrc!
        MMS_Source = 3*ug0*vgy - 6*mug*vgy*xt - 6*vg0*vgy*xt + 3*vgy**2*xt - 6*ug0*vgy*yt + &
       6*vg0*vgy*xt*yt - 12*vgy**2*xt*yt + 3*ug0*vgy*yt**2 + 18*vgy**2*xt*yt**2 - &
       12*vgy**2*xt*yt**3 + 3*vgy**2*xt*yt**4 - 2*pgx*Pi*Sin(2*Pi*(xt + yt)) + &
       4*pgx*Pi*yt*Sin(2*Pi*(xt + yt)) - 2*pgx*Pi*yt**2*Sin(2*Pi*(xt + yt))
      CASE(3)
      !vgsrc!
        MMS_Source = -6*mug*vgy - 3*vg0*vgy - 3*vgy**2 + 6*mug*vgy*yt + 6*vg0*vgy*yt + 15*vgy**2*yt - &
       3*vg0*vgy*yt**2 - 30*vgy**2*yt**2 + 30*vgy**2*yt**3 - 15*vgy**2*yt**4 + &
       3*vgy**2*yt**5 - 2*pgx*Cos(2*Pi*(xt + yt)) + 2*pgx*yt*Cos(2*Pi*(xt + yt)) - &
       2*pgx*Pi*Sin(2*Pi*(xt + yt)) + 4*pgx*Pi*yt*Sin(2*Pi*(xt + yt)) - &
       2*pgx*Pi*yt**2*Sin(2*Pi*(xt + yt))
      CASE(4)
      !wgsrc!
        MMS_Source = ZERO 
      CASE(5)
