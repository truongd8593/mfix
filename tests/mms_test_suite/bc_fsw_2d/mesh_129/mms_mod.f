...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(1)
      !Pg!
        MMS_Function = pg0 + pgx*xt**2*Cos(2*Pi*(xt + yt)) 
      CASE(2)
      !Ug!
        MMS_Function = ug0*xt**3*Sin(2*Pi*(xt + yt))**2
      CASE(3)
      !Vg!
        MMS_Function = 5*vg0 + xt**2*(vg0 - (3*ug0*(xt + yt))/2. + &
          ug0*xt*Cos(2*Pi*(xt + yt))**2 + Sin(2*Pi*xt) + &
          (3*ug0*Sin(4*Pi*(xt + yt)))/(8.*Pi))
      CASE(4)
      !Wg!
        MMS_Function = ZERO
      Case(5)
...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(2)
      !ugsrc!
        MMS_Source = 3*mug*ug0*xt + 2*pgx*xt*Cos(2*Pi*(xt + yt)) - &
       16*mug*Pi**2*ug0*xt**3*Cos(2*Pi*(xt + yt))**2 - &
       3*mug*ug0*xt*Cos(4*Pi*(xt + yt)) - 2*pgx*Pi*xt**2*Sin(2*Pi*(xt + yt)) - &
       36*mug*Pi*ug0*xt**2*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) + &
       20*Pi*ug0*vg0*xt**3*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) + &
       4*Pi*ug0*vg0*xt**5*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) - &
       6*Pi*ug0**2*xt**6*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) - &
       6*Pi*ug0**2*xt**5*yt*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) + &
       4*Pi*ug0**2*xt**6*Cos(2*Pi*(xt + yt))**3*Sin(2*Pi*(xt + yt)) + &
       4*Pi*ug0*xt**5*Cos(2*Pi*(xt + yt))*Sin(2*Pi*xt)*Sin(2*Pi*(xt + yt)) - &
       12*mug*ug0*xt*Sin(2*Pi*(xt + yt))**2 + &
       16*mug*Pi**2*ug0*xt**3*Sin(2*Pi*(xt + yt))**2 - &
       (3*ug0**2*xt**5*Sin(2*Pi*(xt + yt))**2)/2. + &
       (3*ug0**2*xt**5*Cos(4*Pi*(xt + yt))*Sin(2*Pi*(xt + yt))**2)/2. + &
       4*Pi*ug0**2*xt**6*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt))**3 + &
       6*ug0**2*xt**5*Sin(2*Pi*(xt + yt))**4 + &
       6*mug*Pi*ug0*xt**2*Sin(4*Pi*(xt + yt)) + &
       (3*ug0**2*xt**5*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt))*&
          Sin(4*Pi*(xt + yt)))/2.
      CASE(3)
      !vgsrc!
        MMS_Source = -2*mug*vg0 + 9*mug*ug0*xt - 15*ug0*vg0*xt**2 - 3*ug0*vg0*xt**4 + &
       (9*ug0**2*xt**5)/2. + 3*mug*ug0*yt + (9*ug0**2*xt**4*yt)/2. - &
       8*mug*Pi*xt*Cos(2*Pi*xt) - 6*mug*ug0*xt*Cos(2*Pi*(xt + yt))**2 + &
       16*mug*Pi**2*ug0*xt**3*Cos(2*Pi*(xt + yt))**2 - &
       3*ug0**2*xt**5*Cos(2*Pi*(xt + yt))**2 - 6*mug*ug0*xt*Cos(4*Pi*(xt + yt)) + &
       15*ug0*vg0*xt**2*Cos(4*Pi*(xt + yt)) + &
       3*ug0*vg0*xt**4*Cos(4*Pi*(xt + yt)) - &
       (9*ug0**2*xt**5*Cos(4*Pi*(xt + yt)))/2. - &
       (9*ug0**2*xt**4*yt*Cos(4*Pi*(xt + yt)))/2. + &
       3*ug0**2*xt**5*Cos(2*Pi*(xt + yt))**2*Cos(4*Pi*(xt + yt)) - &
       2*mug*Sin(2*Pi*xt) + 4*mug*Pi**2*xt**2*Sin(2*Pi*xt) - &
       3*ug0*xt**4*Sin(2*Pi*xt) + 3*ug0*xt**4*Cos(4*Pi*(xt + yt))*Sin(2*Pi*xt) - &
       2*pgx*Pi*xt**2*Sin(2*Pi*(xt + yt)) + &
       12*mug*Pi*ug0*xt**2*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) - &
       20*Pi*ug0*vg0*xt**3*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) - &
       4*Pi*ug0*vg0*xt**5*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) + &
       6*Pi*ug0**2*xt**6*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) + &
       6*Pi*ug0**2*xt**5*yt*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt)) - &
       4*Pi*ug0**2*xt**6*Cos(2*Pi*(xt + yt))**3*Sin(2*Pi*(xt + yt)) - &
       4*Pi*ug0*xt**5*Cos(2*Pi*(xt + yt))*Sin(2*Pi*xt)*Sin(2*Pi*(xt + yt)) + &
       15*ug0*vg0*xt**2*Sin(2*Pi*(xt + yt))**2 - &
       16*mug*Pi**2*ug0*xt**3*Sin(2*Pi*(xt + yt))**2 + &
       5*ug0*vg0*xt**4*Sin(2*Pi*(xt + yt))**2 - &
       9*ug0**2*xt**5*Sin(2*Pi*(xt + yt))**2 - &
       (15*ug0**2*xt**4*yt*Sin(2*Pi*(xt + yt))**2)/2. + &
       2*Pi*ug0*xt**5*Cos(2*Pi*xt)*Sin(2*Pi*(xt + yt))**2 + &
       6*ug0**2*xt**5*Cos(2*Pi*(xt + yt))**2*Sin(2*Pi*(xt + yt))**2 + &
       (3*ug0**2*xt**5*Cos(4*Pi*(xt + yt))*Sin(2*Pi*(xt + yt))**2)/2. + &
       5*ug0*xt**4*Sin(2*Pi*xt)*Sin(2*Pi*(xt + yt))**2 - &
       4*Pi*ug0**2*xt**6*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt))**3 - &
       (3*mug*ug0*Sin(4*Pi*(xt + yt)))/(4.*Pi) + &
       18*mug*Pi*ug0*xt**2*Sin(4*Pi*(xt + yt)) - &
       (9*ug0**2*xt**4*Sin(4*Pi*(xt + yt)))/(8.*Pi) + &
       (9*ug0**2*xt**4*Cos(4*Pi*(xt + yt))*Sin(4*Pi*(xt + yt)))/(8.*Pi) - &
       (3*ug0**2*xt**5*Cos(2*Pi*(xt + yt))*Sin(2*Pi*(xt + yt))*&
          Sin(4*Pi*(xt + yt)))/2. + &
       (15*ug0**2*xt**4*Sin(2*Pi*(xt + yt))**2*Sin(4*Pi*(xt + yt)))/(8.*Pi)
      CASE(4)
      !wgsrc!
        MMS_Source = ZERO 
      CASE(5)
