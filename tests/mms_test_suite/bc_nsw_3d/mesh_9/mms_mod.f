...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(2)
      !Ug!
        MMS_Function = xt**2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
      ...
      CASE(3)
      !Vg!
        MMS_Function = xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
       ...
       2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - &
          wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))
      CASE(4)
      !Wg!
        MMS_Function = xt**2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + &
       ...
       2*xt*(vg0 + vgy*Cos(avgy*Pi*yt) + vgxy*Cos(avgxy*Pi*xt*yt) + vgz*Cos(avgz*Pi*zt) + &
          vgzx*Cos(avgzx*Pi*xt*zt) + vgx*Sin(avgx*Pi*xt) + vgyz*Sin(avgyz*Pi*yt*zt))  
      Case(5)
      !Us!
        MMS_Function = ZERO
      Case(6)
