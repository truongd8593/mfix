...
! local variables within source functions
      ...
      !ugsrc!
        mms_source = -0.0266666666666667*mug*xt**2*(3.0*yt**2 + 2.0)/(-0.1*xt**2 + 0.7)**3&
         ...
         2.0)/(-0.1*xt**2 + 0.7)**2 + rog*(-0.1*xt**2 + 0.7)*(0.4*xt*(3.0*yt**2 +&
         2.0)**2/(-0.1*xt**2 + 0.7)**3 + 6.0*yt*(3.0*xt**2 + 2.0)/(-0.1*xt**2 +&
         0.7)**2) + 2*xt*(-0.1*xt**2 + 0.7)
      case(3)
      !vgsrc!
        mms_source = -0.4*mug*xt*yt/(-0.1*xt**2 + 0.7)**2 - mug*(2.4*xt**2/(0.1*xt**2 -&
         0.7) - 0.08*xt**2*(3.0*xt**2 + 2.0)/(0.1*xt**2 - 0.7)**2 - 6.0 + (0.6*xt**2 +&
         0.4)/(0.1*xt**2 - 0.7))/(0.1*xt**2 - 0.7) + rog*(-0.1*xt**2 +&
         0.7)*(6.0*xt*(3.0*yt**2 + 2.0)/(-0.1*xt**2 + 0.7)**2 + 0.4*xt*(3.0*xt**2 +&
         2.0)*(3.0*yt**2 + 2.0)/(-0.1*xt**2 + 0.7)**3)
      case(4)
      !wgsrc!
        mms_source = zero
      case(5)
      !ussrc!
        mms_source = -0.0266666666666667*mus*xt**2*(2.0*yt**2 + 1.0)/(0.1*xt**2 + 0.3)**3 -&
         ...
         1.0)/(0.1*xt**2 + 0.3)**2 + ros*(0.1*xt**2 + 0.3)*(-0.4*xt*(2.0*yt**2 +&
         1.0)**2/(0.1*xt**2 + 0.3)**3 + 4.0*yt*(2.0*xt**2 + 1.0)/(0.1*xt**2 + 0.3)**2)&
         + 2*xt*(0.1*xt**2 + 0.3)
      case(6)
      !vssrc!
        mms_source = 0.266666666666667*mus*xt*yt/(0.1*xt**2 + 0.3)**2 -&
         ...
         ros*(0.1*xt**2 + 0.3)*(4.0*xt*(2.0*yt**2 + 1.0)/(0.1*xt**2 + 0.3)**2 -&
         0.4*xt*(2.0*xt**2 + 1.0)*(2.0*yt**2 + 1.0)/(0.1*xt**2 + 0.3)**3)
      case(7)
      !wssrc!
        mms_source = zero
      case(8)
