...
!                aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0               
      ...
      case(10)
      !ep_g!
        mms_function = 1.0d0 - ( 0.0*xt**2 + 0.3 )
      case(11)
      !rop_s!
        mms_function = ros*(0.0*xt**2 + 0.3)
      case(12)
      !theta_m!
        mms_function = zero
      end select
...
! local variables within source functions
      ...
      case(2)
      !ugsrc!
        mms_source = -6.0*mug + 6.0*rog*yt*(-0.0*xt**2 + 0.7)*(3.0*xt**2 + 2.0) +&
         2*xt*(-0.0*xt**2 + 0.7)
      case(3)
      !vgsrc!
        mms_source = -6.0*mug + 6.0*rog*xt*(-0.0*xt**2 + 0.7)*(3.0*yt**2 + 2.0)
      case(4)
      !wgsrc!
        mms_source = zero
      case(5)
      !ussrc!
        mms_source = -4.0*mus + 4.0*ros*yt*(0.0*xt**2 + 0.3)*(2.0*xt**2 + 1.0) +&
         2*xt*(0.0*xt**2 + 0.3)
      case(6)
      !vssrc!
        mms_source = -4.0*mus + 4.0*ros*xt*(0.0*xt**2 + 0.3)*(2.0*yt**2 + 1.0)
      case(7)
      !wssrc!
        mms_source = zero
      case(8)
      ...
      case(10)
      !ropgsrc!
        mms_source = -0.0*rog*xt*(3.0*yt**2 + 2.0)
      case(11)
      !ropssrc!
        mms_source = zero
      case(12)
