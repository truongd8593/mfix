...
!-----------------------------------------------
      ...
      IMPLICIT NONE
        ...
        ! values.
        LOGICAL         :: VECTOR_DATA_FLAG = .FALSE.
        ...
        if(myPE == PE_IO) then
          ...
          !! Uncomment to plot mesh nodes
!          OPEN(UNIT = 776, FILE="mesh.dat", Status='unknown')
!          Write(776,"(27a)") 'variables = "x""y""z"'
!          !Write(776,"(27a)") 'variables = "x""y"'
!          Write(776,*) 'zone T="',0,'" '
!          Write(776,*) 'I=',IMAX+1,' J=',JMAX+1,' K=',KMAX+1
!          !Write(776,*) 'I=',IMAX+1,' J=',JMAX+1
!
!          !K=1
!          DO K = 1, KMAX+1
!          DO J = 1, JMAX+1
!          DO I = 1, IMAX+1
!             IJK = FUNIJK_GL(I,J,K)
!             Write(776,*) arr_xtr(IJK),arr_ytr(IJK),arr_ztr(IJK)
!             !Write(776,*) arr_xtr(IJK),arr_ytr(IJK)
!          END DO
!          END DO
!          END DO
!
