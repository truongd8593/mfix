...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(1)
      !Pg!
        MMS_Function = pg0 + (1 - yt)**2*(pgx*Cos(apgx*Pi*xt) + pgy*Cos(apgy*Pi*yt) + pgxy*Cos(apgxy*Pi*xt*yt) + pgzx*Cos(apgzx*Pi*xt*zt) + &
          pgz*Sin(apgz*Pi*zt) + pgyz*Sin(apgyz*Pi*yt*zt)) 
      CASE(2)
      !Ug!
        MMS_Function = ug0 + (1 - yt)**3*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + &
          awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
          3*(1 - yt)**2*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
          wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt)) 
      CASE(3)
      !Vg!
        MMS_Function = vg0 + (1 - yt)**3*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
          awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + &
          awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) 
      CASE(4)
      !Wg!
        MMS_Function = wg0 + (1 - yt)**3*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
          augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
       3*(1 - yt)**2*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
          ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt))
      Case(5)
      !Us!
        MMS_Function = ZERO 
      Case(6)
...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(2)
      !ugsrc!
        MMS_Source = -(mug*(1 - yt)**3*(awgxy**3*Pi**3*wgxy*xt*yt**2*Cos(awgxy*Pi*xt*yt) + 2*awgxy**2*Pi**2*wgxy*yt*Sin(awgxy*Pi*xt*yt))) + &
       (1 - yt)**2*(-(apgx*pgx*Pi*Sin(apgx*Pi*xt)) - apgxy*pgxy*Pi*yt*Sin(apgxy*Pi*xt*yt) - apgzx*pgzx*Pi*zt*Sin(apgzx*Pi*xt*zt)) + &
       3*mug*(1 - yt)**2*(awgx**2*Pi**2*wgx*Cos(awgx*Pi*xt) - augzx**2*Pi**2*ugzx*xt*zt*Cos(augzx*Pi*xt*zt) + &
          awgzx**2*Pi**2*wgzx*zt**2*Cos(awgzx*Pi*xt*zt) + awgxy**2*Pi**2*wgxy*yt**2*Sin(awgxy*Pi*xt*yt) - &
          augzx*Pi*ugzx*Sin(augzx*Pi*xt*zt)) - mug*(3*(1 - yt)**2*&
           (awgx**2*Pi**2*wgx*Cos(awgx*Pi*xt) + awgzx**2*Pi**2*wgzx*zt**2*Cos(awgzx*Pi*xt*zt) + &
             awgxy**2*Pi**2*wgxy*yt**2*Sin(awgxy*Pi*xt*yt)) + &
          (1 - yt)**3*(-(awgxy**3*Pi**3*wgxy*xt*yt**2*Cos(awgxy*Pi*xt*yt)) + 2*avgzx**2*Pi**2*vgzx*zt*Cos(avgzx*Pi*xt*zt) - &
             2*awgxy**2*Pi**2*wgxy*yt*Sin(awgxy*Pi*xt*yt) - avgzx**3*Pi**3*vgzx*xt*zt**2*Sin(avgzx*Pi*xt*zt))) - &
       mug*(3*(1 - yt)**2*(-(augzx**2*Pi**2*ugzx*xt*zt*Cos(augzx*Pi*xt*zt)) - augzx*Pi*ugzx*Sin(augzx*Pi*xt*zt)) + &
          (1 - yt)**3*(-2*avgzx**2*Pi**2*vgzx*zt*Cos(avgzx*Pi*xt*zt) + avgzx**3*Pi**3*vgzx*xt*zt**2*Sin(avgzx*Pi*xt*zt))) + &
       2*((1 - yt)**3*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - &
             awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt)) + &
          3*(1 - yt)**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + awgx*Pi*wgx*Sin(awgx*Pi*xt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)))&
         *(ug0 + (1 - yt)**3*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
             avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + &
             avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + 3*(1 - yt)**2*&
           (-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
             wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) + &
       (-3*(1 - yt)**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - &
             augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          (1 - yt)**3*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + &
        ...
        (ug0 + (1 - yt)**3*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
           ...
           (-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
             wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) + &
       (3*(1 - yt)**2*(augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt)) + &
          (1 - yt)**3*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - &
        ...
        (ug0 + (1 - yt)**3*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
           ...
           (-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
             wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) + &
       (wg0 + (1 - yt)**3*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
             augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          3*(1 - yt)**2*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
             ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt)))*&
        (3*(1 - yt)**2*(-(awgyz*Pi*wgyz*yt*Cos(awgyz*Pi*yt*zt)) + awgz*Pi*wgz*Sin(awgz*Pi*zt) + &
             awgzx*Pi*wgzx*xt*Sin(awgzx*Pi*xt*zt)) + (1 - yt)**3*&
       ...
       (vg0 + (1 - yt)**3*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)))*(3*(1 - yt)**2*&
           (-(awgy*Pi*wgy*Cos(awgy*Pi*yt)) - awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt)) - &
          3*(1 - yt)**2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + &
             awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) - &
          6*(1 - yt)*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
             wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt)) + &
          (1 - yt)**3*(-(avgyz*Pi*vgyz*Cos(avgyz*Pi*yt*zt)) - awgy**2*Pi**2*wgy*Sin(awgy*Pi*yt) - &
       ...
       mug*(-12*(1 - yt)*(-(awgy*Pi*wgy*Cos(awgy*Pi*yt)) - awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
             awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt)) + 3*(1 - yt)**2*&
           (awgx**2*Pi**2*wgx*Cos(awgx*Pi*xt) + awgzx**2*Pi**2*wgzx*zt**2*Cos(awgzx*Pi*xt*zt) + &
             awgxy**2*Pi**2*wgxy*yt**2*Sin(awgxy*Pi*xt*yt)) + &
          6*(1 - yt)*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + &
             awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
          (1 - yt)**3*(awgxy*Pi*wgxy*(-(awgxy**2*Pi**2*xt*yt**2*Cos(awgxy*Pi*xt*yt)) - 2*awgxy*Pi*yt*Sin(awgxy*Pi*xt*yt)) + &
             avgzx*Pi*vgzx*(2*avgzx*Pi*zt*Cos(avgzx*Pi*xt*zt) - avgzx**2*Pi**2*xt*zt**2*Sin(avgzx*Pi*xt*zt))) + &
          (1 - yt)**3*(-(awgy**3*Pi**3*wgy*Cos(awgy*Pi*yt)) - awgxy**3*Pi**3*wgxy*xt**3*Cos(awgxy*Pi*xt*yt) - &
          ...
          6*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
             wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt)) + &
          3*(1 - yt)**2*(awgz**2*Pi**2*wgz*Cos(awgz*Pi*zt) + awgzx**2*Pi**2*wgzx*xt**2*Cos(awgzx*Pi*xt*zt) + &
             awgyz**2*Pi**2*wgyz*yt**2*Sin(awgyz*Pi*yt*zt)) - &
          6*(1 - yt)**2*(-(avgyz*Pi*vgyz*Cos(avgyz*Pi*yt*zt)) - awgy**2*Pi**2*wgy*Sin(awgy*Pi*yt) - &
             awgxy**2*Pi**2*wgxy*xt**2*Sin(awgxy*Pi*xt*yt) + avgyz**2*Pi**2*vgyz*yt*zt*Sin(avgyz*Pi*yt*zt) - &
             awgyz**2*Pi**2*wgyz*zt**2*Sin(awgyz*Pi*yt*zt)) + &
          3*(1 - yt)**2*(awgy**2*Pi**2*wgy*Sin(awgy*Pi*yt) + awgxy**2*Pi**2*wgxy*xt**2*Sin(awgxy*Pi*xt*yt) + &
             awgyz**2*Pi**2*wgyz*zt**2*Sin(awgyz*Pi*yt*zt)) + &
          (1 - yt)**3*(avgyz**3*Pi**3*vgyz*yt**3*Cos(avgyz*Pi*yt*zt) - avgz**3*Pi**3*vgz*Sin(avgz*Pi*zt) - &
      ...
      CASE(3)
      !vgsrc!
        MMS_Source =  (1 - yt)**2*(apgyz*pgyz*Pi*zt*Cos(apgyz*Pi*yt*zt) - apgy*pgy*Pi*Sin(apgy*Pi*yt) - apgxy*pgxy*Pi*xt*Sin(apgxy*Pi*xt*yt)) - &
       mug*((1 - yt)**3*(-(awgxy**3*Pi**3*wgxy*xt**2*yt*Cos(awgxy*Pi*xt*yt)) - 2*awgxy**2*Pi**2*wgxy*xt*Sin(awgxy*Pi*xt*yt)) + &
          3*(1 - yt)**2*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt)) - &
          3*(1 - yt)**2*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - &
             awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt)) - &
          6*(1 - yt)*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + awgx*Pi*wgx*Sin(awgx*Pi*xt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt))) + &
       ((1 - yt)**3*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - &
             awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt)) + &
          3*(1 - yt)**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + awgx*Pi*wgx*Sin(awgx*Pi*xt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)))&
         *(vg0 + (1 - yt)**3*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt))) - &
       2*(1 - yt)*(pgx*Cos(apgx*Pi*xt) + pgy*Cos(apgy*Pi*yt) + pgxy*Cos(apgxy*Pi*xt*yt) + pgzx*Cos(apgzx*Pi*xt*zt) + &
          pgz*Sin(apgz*Pi*zt) + pgyz*Sin(apgyz*Pi*yt*zt)) + &
       (1 - yt)**3*(-(augz**2*Pi**2*ugz*Cos(augz*Pi*zt)) - augzx**2*Pi**2*ugzx*xt**2*Cos(augzx*Pi*xt*zt) + &
        ...
        (wg0 + (1 - yt)**3*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
          ...
          3*(1 - yt)**2*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
             ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt))) - &
       mug*(6*(1 - yt)*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - &
             augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          (1 - yt)**3*(awgxy**3*Pi**3*wgxy*xt**2*yt*Cos(awgxy*Pi*xt*yt) - augyz**3*Pi**3*ugyz*yt*zt**2*Cos(augyz*Pi*yt*zt) + &
             2*awgxy**2*Pi**2*wgxy*xt*Sin(awgxy*Pi*xt*yt) - 2*augyz**2*Pi**2*ugyz*zt*Sin(augyz*Pi*yt*zt)) - &
          6*(1 - yt)**2*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + &
             awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) + &
       2*(vg0 + (1 - yt)**3*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)))*(-3*(1 - yt)**2*&
           (-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - &
             augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          (1 - yt)**3*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + &
             awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) - &
       mug*(-6*(1 - yt)*(augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt)) + &
          (1 - yt)**3*(augyz**3*Pi**3*ugyz*yt*zt**2*Cos(augyz*Pi*yt*zt) + 2*augyz**2*Pi**2*ugyz*zt*Sin(augyz*Pi*yt*zt)) + &
          3*(1 - yt)**2*(augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt)) - &
          3*(1 - yt)**2*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - &
             avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt) + augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) + &
       (vg0 + (1 - yt)**3*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)))*(3*(1 - yt)**2*&
           (augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt)) + &
          (1 - yt)**3*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - &
             avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt) + augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) - &
       mug*(6*(1 - yt)*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - &
             augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          (1 - yt)**3*(awgxy**3*Pi**3*wgxy*yt**3*Cos(awgxy*Pi*xt*yt) - awgx**3*Pi**3*wgx*Sin(awgx*Pi*xt) - &
          ...
          (1 - yt)**3*(-(augyz**3*Pi**3*ugyz*yt**3*Cos(augyz*Pi*yt*zt)) + augz**3*Pi**3*ugz*Sin(augz*Pi*zt) + &
          ...
          6*(1 - yt)**2*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + &
             awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt)) + &
          (1 - yt)**3*(-(awgxy*Pi*(-(awgxy**2*Pi**2*wgxy*xt**2*yt*Cos(awgxy*Pi*xt*yt)) - 2*awgxy*Pi*wgxy*xt*Sin(awgxy*Pi*xt*yt))) + &
             augyz*Pi*ugyz*(-(augyz**2*Pi**2*yt*zt**2*Cos(augyz*Pi*yt*zt)) - 2*augyz*Pi*zt*Sin(augyz*Pi*yt*zt)))) + &
       (1 - yt)**3*(awgx**2*Pi**2*wgx*Cos(awgx*Pi*xt) - augzx**2*Pi**2*ugzx*xt*zt*Cos(augzx*Pi*xt*zt) + &
          awgzx**2*Pi**2*wgzx*zt**2*Cos(awgzx*Pi*xt*zt) + awgxy**2*Pi**2*wgxy*yt**2*Sin(awgxy*Pi*xt*yt) - &
          augzx*Pi*ugzx*Sin(augzx*Pi*xt*zt))*(ug0 + (1 - yt)**3*&
      ...
      CASE(4)
      !wgsrc!
        MMS_Source =  (1 - yt)**2*(apgz*pgz*Pi*Cos(apgz*Pi*zt) + apgyz*pgyz*Pi*yt*Cos(apgyz*Pi*yt*zt) - apgzx*pgzx*Pi*xt*Sin(apgzx*Pi*xt*zt)) - &
       mug*((1 - yt)**3*(2*avgzx**2*Pi**2*vgzx*xt*Cos(avgzx*Pi*xt*zt) - avgzx**3*Pi**3*vgzx*xt**2*zt*Sin(avgzx*Pi*xt*zt)) + &
          3*(1 - yt)**2*(awgzx**2*Pi**2*wgzx*xt*zt*Cos(awgzx*Pi*xt*zt) + awgzx*Pi*wgzx*Sin(awgzx*Pi*xt*zt))) - &
       mug*(1 - yt)**3*(-(augyz**3*Pi**3*ugyz*yt**2*zt*Cos(augyz*Pi*yt*zt)) - 2*augyz**2*Pi**2*ugyz*yt*Sin(augyz*Pi*yt*zt)) + &
       3*mug*(1 - yt)**2*(-(augz**2*Pi**2*ugz*Cos(augz*Pi*zt)) - augzx**2*Pi**2*ugzx*xt**2*Cos(augzx*Pi*xt*zt) + &
          awgzx**2*Pi**2*wgzx*xt*zt*Cos(awgzx*Pi*xt*zt) + awgzx*Pi*wgzx*Sin(awgzx*Pi*xt*zt) - &
          augyz**2*Pi**2*ugyz*yt**2*Sin(augyz*Pi*yt*zt)) + &
       ((1 - yt)**3*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - &
             awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt)) + &
         ...
         *(wg0 + (1 - yt)**3*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
          ...
          3*(1 - yt)**2*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
             ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt))) - &
       mug*((1 - yt)**3*(-2*avgzx**2*Pi**2*vgzx*xt*Cos(avgzx*Pi*xt*zt) + augyz**3*Pi**3*ugyz*yt**2*zt*Cos(augyz*Pi*yt*zt) + &
             avgzx**3*Pi**3*vgzx*xt**2*zt*Sin(avgzx*Pi*xt*zt) + 2*augyz**2*Pi**2*ugyz*yt*Sin(augyz*Pi*yt*zt)) + &
          3*(1 - yt)**2*(-(augz**2*Pi**2*ugz*Cos(augz*Pi*zt)) - augzx**2*Pi**2*ugzx*xt**2*Cos(augzx*Pi*xt*zt) - &
             augyz**2*Pi**2*ugyz*yt**2*Sin(augyz*Pi*yt*zt))) + &
       (wg0 + (1 - yt)**3*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
             augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          3*(1 - yt)**2*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
             ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt)))*&
        (-3*(1 - yt)**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + (1 - yt)**3*&
           (-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) + &
       2*(wg0 + (1 - yt)**3*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
             augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          3*(1 - yt)**2*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
             ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt)))*&
        (3*(1 - yt)**2*(augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt)) + &
       ...
       (vg0 + (1 - yt)**3*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)))*(3*(1 - yt)**2*&
           (augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) - augy*Pi*ugy*Sin(augy*Pi*yt) - augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt)) - &
          3*(1 - yt)**2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
             augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) - &
          6*(1 - yt)*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
             ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt)) + &
          (1 - yt)**3*(augy**2*Pi**2*ugy*Cos(augy*Pi*yt) + augxy**2*Pi**2*ugxy*xt**2*Cos(augxy*Pi*xt*yt) - &
             avgxy**2*Pi**2*vgxy*xt*yt*Cos(avgxy*Pi*xt*yt) - avgxy*Pi*vgxy*Sin(avgxy*Pi*xt*yt) + &
             augyz**2*Pi**2*ugyz*zt**2*Sin(augyz*Pi*yt*zt))) - &
       mug*(3*(1 - yt)**2*(-(augxy**2*Pi**2*ugxy*yt**2*Cos(augxy*Pi*xt*yt)) - augzx**2*Pi**2*ugzx*zt**2*Cos(augzx*Pi*xt*zt) - &
             augx**2*Pi**2*ugx*Sin(augx*Pi*xt)) - 12*(1 - yt)*&
           (augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) - augy*Pi*ugy*Sin(augy*Pi*yt) - augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt)) + &
          (1 - yt)**3*(augyz**3*Pi**3*ugyz*zt**3*Cos(augyz*Pi*yt*zt) - augy**3*Pi**3*ugy*Sin(augy*Pi*yt) - &
          ...
          6*(1 - yt)*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
             augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          (1 - yt)**3*(-(avgx**3*Pi**3*vgx*Cos(avgx*Pi*xt)) + &
          ...
          6*(ug0 + ugy*Cos(augy*Pi*yt) + ugxy*Cos(augxy*Pi*xt*yt) + ugz*Cos(augz*Pi*zt) + ugzx*Cos(augzx*Pi*xt*zt) + &
             ugx*Sin(augx*Pi*xt) + ugyz*Sin(augyz*Pi*yt*zt)) + &
          3*(1 - yt)**2*(-(augz**2*Pi**2*ugz*Cos(augz*Pi*zt)) - augzx**2*Pi**2*ugzx*xt**2*Cos(augzx*Pi*xt*zt) - &
             augyz**2*Pi**2*ugyz*yt**2*Sin(augyz*Pi*yt*zt)) + &
          3*(1 - yt)**2*(-(augy**2*Pi**2*ugy*Cos(augy*Pi*yt)) - augxy**2*Pi**2*ugxy*xt**2*Cos(augxy*Pi*xt*yt) - &
             augyz**2*Pi**2*ugyz*zt**2*Sin(augyz*Pi*yt*zt)) - &
          6*(1 - yt)**2*(augy**2*Pi**2*ugy*Cos(augy*Pi*yt) + augxy**2*Pi**2*ugxy*xt**2*Cos(augxy*Pi*xt*yt) - &
             avgxy**2*Pi**2*vgxy*xt*yt*Cos(avgxy*Pi*xt*yt) - avgxy*Pi*vgxy*Sin(avgxy*Pi*xt*yt) + &
             augyz**2*Pi**2*ugyz*zt**2*Sin(augyz*Pi*yt*zt)) + &
          (1 - yt)**3*(-(avgzx*Pi*(2*avgzx*Pi*vgzx*xt*Cos(avgzx*Pi*xt*zt) - avgzx**2*Pi**2*vgzx*xt**2*zt*Sin(avgzx*Pi*xt*zt))) - &
             augyz*Pi*(-(augyz**2*Pi**2*ugyz*yt**2*zt*Cos(augyz*Pi*yt*zt)) - 2*augyz*Pi*ugyz*yt*Sin(augyz*Pi*yt*zt)))) + &
       ((1 - yt)**3*(augxy**2*Pi**2*ugxy*xt*yt*Cos(augxy*Pi*xt*yt) - avgxy**2*Pi**2*vgxy*yt**2*Cos(avgxy*Pi*xt*yt) - &
             avgzx**2*Pi**2*vgzx*zt**2*Cos(avgzx*Pi*xt*zt) - avgx**2*Pi**2*vgx*Sin(avgx*Pi*xt) + augxy*Pi*ugxy*Sin(augxy*Pi*xt*yt)) + &
          3*(1 - yt)**2*(augx*Pi*ugx*Cos(augx*Pi*xt) - augxy*Pi*ugxy*yt*Sin(augxy*Pi*xt*yt) - augzx*Pi*ugzx*zt*Sin(augzx*Pi*xt*zt)))*&
        (ug0 + (1 - yt)**3*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
             avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + &
             avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + 3*(1 - yt)**2*&
           (-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
