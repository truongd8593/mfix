...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(2)
      !Ug!
        MMS_Function = xt**3*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + &
         awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) 
      CASE(3)
      !Vg!
        MMS_Function = vg0 + xt**3*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - &
      ...
      CASE(4)
      !Wg!
        MMS_Function = wg0 + xt**3*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
