...
!        apgzx=0.8d0 
      ...
      DOUBLE PRECISION :: es0=0.3d0, esx=0.0d0, esy=0.0d0, esz=0.0d0, &
...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      Case(8)
      !Tg!
        MMS_Function = Tg0 + Tgx*Cos(aTgx*Pi*xt) + Tgy*Cos(aTgy*Pi*yt) + Tgxy*Cos(aTgxy*Pi*xt*yt) + &
         Tgzx*Cos(aTgzx*Pi*xt*zt) + Tgz*Sin(aTgz*Pi*zt) + Tgyz*Sin(aTgyz*Pi*yt*zt)
      Case(9)
      !Ts!
        MMS_Function = Ts0 + Tsx*Cos(aTsx*Pi*xt) + Tsy*Cos(aTsy*Pi*yt) + Tsxy*Cos(aTsxy*Pi*xt*yt) +& 
         Tszx*Cos(aTszx*Pi*xt*zt) + Tsz*Sin(aTsz*Pi*zt) + Tsyz*Sin(aTsyz*Pi*yt*zt)
      Case(10)
      !Ep_g!
        MMS_Function = 1. - es0 - esx*Cos(aesx*Pi*xt) - esy*Cos(aesy*Pi*yt) - &
         esxy*Cos(aesxy*Pi*xt*yt) - eszx*Cos(aeszx*Pi*xt*zt) - esz*Sin(aesz*Pi*zt) - &
      ...
      Case(12)
      !Theta_m!
        MMS_Function = Ths0 + Thsx*Cos(aThsx*Pi*xt) + Thsy*Cos(aThsy*Pi*yt) + &
...
!        aesx=0.5d0, aesy=0.5d0, aesz=0.5d0, aesxy=0.4d0, aesyz=0.4d0, aeszx=0.4d0
      ...
      CASE(5)
      !ussrc!
        MMS_Source =  -(mus*Pi**2*us0*Cos((Pi*(xt + yt + zt))/2.)**2)/2. + &
         ...
         ros*(es0 + esx*Cos(aesx*Pi*xt) + esy*Cos(aesy*Pi*yt) + &
            esxy*Cos(aesxy*Pi*xt*yt) + eszx*Cos(aeszx*Pi*xt*zt) + &
            esz*Sin(aesz*Pi*zt) + esyz*Sin(aesyz*Pi*yt*zt))*&
          (Pi*us0*ws0*Cos((Pi*(xt + yt + zt))/2.)*Sin((Pi*(xt + yt + zt))/2.) + &
            Pi*us0*vs0*Cos((Pi*(xt + yt + zt))/2.)**3*Sin((Pi*(xt + yt + zt))/2.) + &
            2*Pi*us0**2*Cos((Pi*(xt + yt + zt))/2.)*Sin((Pi*(xt + yt + zt))/2.)**3 - &
            Pi*us0*vs0*Cos((Pi*(xt + yt + zt))/2.)*Sin((Pi*(xt + yt + zt))/2.)**3)
      CASE(6)
      !vssrc!
        MMS_Source = -(mus*Pi**2*us0*Cos((Pi*(xt + yt + zt))/2.)**2)/2. + &
         (mus*Pi**2*vs0*Cos((Pi*(xt + yt + zt))/2.)**2)/2. + &
         ...
         ros*(es0 + esx*Cos(aesx*Pi*xt) + esy*Cos(aesy*Pi*yt) + &
            esxy*Cos(aesxy*Pi*xt*yt) + eszx*Cos(aeszx*Pi*xt*zt) + &
            esz*Sin(aesz*Pi*zt) + esyz*Sin(aesyz*Pi*yt*zt))*&
          (-(Pi*vs0*ws0*Cos((Pi*(xt + yt + zt))/2.)*Sin((Pi*(xt + yt + zt))/2.)) + &
            Pi*us0*vs0*Cos((Pi*(xt + yt + zt))/2.)**3*Sin((Pi*(xt + yt + zt))/2.) - &
            2*Pi*vs0**2*Cos((Pi*(xt + yt + zt))/2.)**3*Sin((Pi*(xt + yt + zt))/2.) - &
            Pi*us0*vs0*Cos((Pi*(xt + yt + zt))/2.)*Sin((Pi*(xt + yt + zt))/2.)**3)
      CASE(7)
      !wssrc!
        MMS_Source = -(mus*Pi**2*us0*Cos((Pi*(xt + yt + zt))/2.)**2)/2. + &
      ...
      !Tgsrc!
        MMS_Source = -(kg*(-(aTgx**2*Pi**2*Tgx*Cos(aTgx*Pi*xt)) - &
         ...
         Cpg*rog*((-(aTgx*Pi*Tgx*Sin(aTgx*Pi*xt)) - aTgxy*Pi*Tgxy*yt*Sin(aTgxy*Pi*xt*yt) - &
               aTgzx*Pi*Tgzx*zt*Sin(aTgzx*Pi*xt*zt))*&
             (awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
               avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + &
               avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
            (aTgz*Pi*Tgz*Cos(aTgz*Pi*zt) + aTgyz*Pi*Tgyz*yt*Cos(aTgyz*Pi*yt*zt) - &
               aTgzx*Pi*Tgzx*xt*Sin(aTgzx*Pi*xt*zt))*&
             (avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + &
               augy*Pi*ugy*Sin(augy*Pi*yt) + augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - &
               avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
            (aTgyz*Pi*Tgyz*zt*Cos(aTgyz*Pi*yt*zt) - aTgy*Pi*Tgy*Sin(aTgy*Pi*yt) - &
               aTgxy*Pi*Tgxy*xt*Sin(aTgxy*Pi*xt*yt))*&
             (-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
          ...
          (1. - es0 - esx*Cos(aesx*Pi*xt) - esy*Cos(aesy*Pi*yt) - esxy*Cos(aesxy*Pi*xt*yt) - &
            eszx*Cos(aeszx*Pi*xt*zt) - esz*Sin(aesz*Pi*zt) - esyz*Sin(aesyz*Pi*yt*zt)) - &
         kg*(-(aTgzx**2*Pi**2*Tgzx*xt**2*Cos(aTgzx*Pi*xt*zt)) - aTgz**2*Pi**2*Tgz*Sin(aTgz*Pi*zt) - &
            aTgyz**2*Pi**2*Tgyz*yt**2*Sin(aTgyz*Pi*yt*zt)) - &
         kg*(-(aTgy**2*Pi**2*Tgy*Cos(aTgy*Pi*yt)) - aTgxy**2*Pi**2*Tgxy*xt**2*Cos(aTgxy*Pi*xt*yt) - &
      ...
      !Tssrc!
        MMS_Source = -(ks*(-(aTsx**2*Pi**2*Tsx*Cos(aTsx*Pi*xt)) - &
         ...
         ks*(-(aTszx**2*Pi**2*Tszx*xt**2*Cos(aTszx*Pi*xt*zt)) - aTsz**2*Pi**2*Tsz*Sin(aTsz*Pi*zt) - &
            aTsyz**2*Pi**2*Tsyz*yt**2*Sin(aTsyz*Pi*yt*zt)) - &
         ks*(-(aTsy**2*Pi**2*Tsy*Cos(aTsy*Pi*yt)) - aTsxy**2*Pi**2*Tsxy*xt**2*Cos(aTsxy*Pi*xt*yt) - &
            aTsyz**2*Pi**2*Tsyz*zt**2*Sin(aTsyz*Pi*yt*zt)) + &
         Cps*ros*(es0 + esx*Cos(aesx*Pi*xt) + esy*Cos(aesy*Pi*yt) + esxy*Cos(aesxy*Pi*xt*yt) + &
            eszx*Cos(aeszx*Pi*xt*zt) + esz*Sin(aesz*Pi*zt) + esyz*Sin(aesyz*Pi*yt*zt))*&
          (vs0*Cos((Pi*(xt + yt + zt))/2.)**2*&
             (aTsyz*Pi*Tsyz*zt*Cos(aTsyz*Pi*yt*zt) - aTsy*Pi*Tsy*Sin(aTsy*Pi*yt) - &
               aTsxy*Pi*Tsxy*xt*Sin(aTsxy*Pi*xt*yt)) + &
            ws0*(aTsz*Pi*Tsz*Cos(aTsz*Pi*zt) + aTsyz*Pi*Tsyz*yt*Cos(aTsyz*Pi*yt*zt) - &
               aTszx*Pi*Tszx*xt*Sin(aTszx*Pi*xt*zt)) + &
            us0*(-(aTsx*Pi*Tsx*Sin(aTsx*Pi*xt)) - aTsxy*Pi*Tsxy*yt*Sin(aTsxy*Pi*xt*yt) - &
               aTszx*Pi*Tszx*zt*Sin(aTszx*Pi*xt*zt))*Sin((Pi*(xt + yt + zt))/2.)**2)
      CASE(10)
      !ropgsrc!
      ...
      !Thssrc!
        MMS_Source = -(ks*(-(aThsx**2*Pi**2*Thsx*Cos(aThsx*Pi*xt)) - &
         ...
         ks*(-(aThszx**2*Pi**2*Thszx*xt**2*Cos(aThszx*Pi*xt*zt)) - &
            aThsz**2*Pi**2*Thsz*Sin(aThsz*Pi*zt) - aThsyz**2*Pi**2*Thsyz*yt**2*Sin(aThsyz*Pi*yt*zt))&
         ...
         (3*ros*(es0 + esx*Cos(aesx*Pi*xt) + esy*Cos(aesy*Pi*yt) + esxy*Cos(aesxy*Pi*xt*yt) + &
              eszx*Cos(aeszx*Pi*xt*zt) + esz*Sin(aesz*Pi*zt) + esyz*Sin(aesyz*Pi*yt*zt))*&
            (vs0*Cos((Pi*(xt + yt + zt))/2.)**2*&
               (aThsyz*Pi*Thsyz*zt*Cos(aThsyz*Pi*yt*zt) - aThsy*Pi*Thsy*Sin(aThsy*Pi*yt) - &
                 aThsxy*Pi*Thsxy*xt*Sin(aThsxy*Pi*xt*yt)) + &
              ws0*(aThsz*Pi*Thsz*Cos(aThsz*Pi*zt) + aThsyz*Pi*Thsyz*yt*Cos(aThsyz*Pi*yt*zt) - &
                 aThszx*Pi*Thszx*xt*Sin(aThszx*Pi*xt*zt)) + &
              Pi*us0*Cos((Pi*(xt + yt + zt))/2.)*&
               (Ths0 + Thsx*Cos(aThsx*Pi*xt) + Thsy*Cos(aThsy*Pi*yt) + Thsxy*Cos(aThsxy*Pi*xt*yt) + &
                 Thszx*Cos(aThszx*Pi*xt*zt) + Thsz*Sin(aThsz*Pi*zt) + Thsyz*Sin(aThsyz*Pi*yt*zt))*&
               Sin((Pi*(xt + yt + zt))/2.) - &
              Pi*vs0*Cos((Pi*(xt + yt + zt))/2.)*&
               (Ths0 + Thsx*Cos(aThsx*Pi*xt) + Thsy*Cos(aThsy*Pi*yt) + Thsxy*Cos(aThsxy*Pi*xt*yt) + &
                 Thszx*Cos(aThszx*Pi*xt*zt) + Thsz*Sin(aThsz*Pi*zt) + Thsyz*Sin(aThsyz*Pi*yt*zt))*&
               Sin((Pi*(xt + yt + zt))/2.) + &
              us0*(-(aThsx*Pi*Thsx*Sin(aThsx*Pi*xt)) - aThsxy*Pi*Thsxy*yt*Sin(aThsxy*Pi*xt*yt) - &
                 aThszx*Pi*Thszx*zt*Sin(aThszx*Pi*xt*zt))*Sin((Pi*(xt + yt + zt))/2.)**2))/2.
        !MMS_Source = ZERO
      END SELECT
