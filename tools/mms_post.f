...
!
      ...
      WRITE(*,*) 
!
      OPEN (UNIT=10,FILE='files_post.lis',STATUS='OLD')            
!
...
C  Initialization
C
      OPEN (UNIT=30,FILE='post_u.make',STATUS='UNKNOWN')
      OPEN (UNIT=31,FILE='post_l.make',STATUS='UNKNOWN')
C
...
c
     ...
     &                                     BACK
      ...
      write (30,'(a)') '    '
      write (31,'(a)') '    '
c      write (30,'(a)') '    blas90.a odepack.a dgtsv90.a'
c      write (31,'(a)') '    blas90.a odepack.a dgtsv90.a'
...
C
     ...
     &                               '.$(OBJ_EXT) ',  BACK
      END DO
      WRITE (30,*) ' -o post_mfix $(LIB_FLAGS)'
      WRITE (30,*) ' '            
      WRITE (31,*) ' -o post_mfix $(LIB_FLAGS)'
      WRITE (31,*) ' ' 
C
