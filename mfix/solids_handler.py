# methods to deal with solids, split off from mfix.py
...
from mfix.tools import keyword_args

from mfix.widgets.base import LineEdit

from mfix.solids_tfm import SolidsTFM
from mfix.solids_dem import SolidsDEM
from mfix.solids_pic import SolidsPIC
