...
from mfix.tools.general import get_selected_row
...
# local imports
from mfix.project import Keyword, Equation, FloatExp, make_FloatExp
from mfix.regexes import *
from mfix.constants import *
from mfix.tools.general import (to_text_string, get_icon, insert_append_action,
                           insert_append_separator, get_unique_string)
from mfix.tools.simpleeval import VALID_EXPRESION_NAMES
