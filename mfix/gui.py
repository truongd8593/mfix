...
from mfix.tools.general import SCRIPT_DIRECTORY
...
# local imports
from mfix.project_manager import ProjectManager
from mfix.project import Equation
from mfix.job import JobManager, get_dict_from_pidfile
from mfix.monitor import Monitor

from mfix.widgets.base import (LineEdit, CheckBox, ComboBox, SpinBox, DoubleSpinBox,
                          Table, BaseWidget)
from mfix.widgets.regions import RegionsWidget
from mfix.widgets.linear_equation_table import LinearEquationTable
from mfix.widgets.species_popup import SpeciesPopup
from mfix.widgets.regions_popup import RegionsPopup
from mfix.widgets.run_popup import RunPopup
from mfix.widgets.workflow import WorkflowWidget, PYQTNODE_AVAILABLE
from mfix.widgets.parameter_dialog import ParameterDialog

from mfix.model_setup import ModelSetup
from mfix.fluid_handler import FluidHandler
from mfix.solids_handler import SolidsHandler
from mfix.ics import ICS
from mfix.bcs import BCS
from mfix.pss import PSS
from mfix.iss import ISS
from mfix.mesh import Mesh
from mfix.chemistry import Chemistry

from mfix.interpreter import Interpreter

from mfix.tools.general import (get_icon, get_mfix_home, widget_iter,
                           is_text_string, is_unicode,
                           format_key_with_args, to_unicode_from_fs)

from mfix.tools.namelistparser import buildKeywordDoc
from mfix.tools.keyword_args import keyword_args
...
class MfixGui(QtWidgets.QMainWindow,
    ...
    def init_vtk_widget(self):
        ...
        if not 'MFIX_NO_VTK' in os.environ: # Avoid importing vtkwidget if MFIX_NO_VTK set
            from mfix.widgets.vtkwidget import VTK_AVAILABLE
        ...
        from mfix.widgets.vtkwidget import VtkWidget
