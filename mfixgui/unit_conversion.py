...
#<start generated code>
    ...
    'bc_hw_x_g': 1,
    'bc_hw_x_s': 1,
    'bc_jet_g0': 1e-2, # cm/s -> m/s
    'bc_jet_gh': 1e-2,
    'bc_jet_gl': 1e-2,
    'bc_k_turb_g': 1e-4, # cm^2/s^3 -> m^2/s^3
    'bc_massflow_g': 1e-3, #g/s -> kg/s
    'bc_massflow_s': 1e-3,
    'bc_p_g': 0.1,   # barye->Pa
...
#   'bc_velmag_s': UNDEFINED,
    'bc_volflow_g': 1e-6, # cm^3/s -> m^3/s
    'bc_volflow_s': 1e-6,
    'bc_vw_g': 1e-2,
    'bc_vw_s': 1,
    'bc_w_g': 1,
...
#   'mew_w': UNDEFINED,
    'mppic_coeff_en1': 1,
    'mppic_coeff_en2': 1,
    'mppic_coeff_en_wall': 1,
    'mppic_coeff_et_wall': 1,
    'mu_g0' : 0.1, # ???
    'mu_gmax': 0.1, # ??? Poise->Pa.s
#   'mu_s0': UNDEFINED,  # ??Pa
    'mw_avg' : 1.0,
    'mw_g' : 1.0,
    'mw_s' : 1.0,
...
#   'piece_zmin': UNDEFINED,
    'ps_massflow_g':  1e-3, #g/s -> kg/s
    'ps_massflow_s':  1e-3, #g/s -> kg/s
    'ps_t_g': 1, #K
    'ps_t_s': 1, #K
    'ps_u_g': 1e-2, #  cm/s->m/s
    'ps_u_s': 1e-2,
    'ps_v_g': 1e-2,
    'ps_v_s': 1e-2,
    'ps_w_g': 1e-2,
...
#   'theta_z': UNDEFINED,
    ...
    #  Is this correct?  Do tol_ variables have dimensions?
    'tol_delh' : 1,
    'tol_diverge': 1,
    'tol_f': 1,
    'tol_msh': 1,
