...
!
      NORMSloc = NORMS
      IF(NORMS == ZERO) THEN
        CALL CALC_RESID_PP (B_MMAX, ONE, NUM_RESID(RESID_P,1), &
         DEN_RESID(RESID_P,1), RESID(RESID_P,1), MAX_RESID(RESID_P,1), &
         IJK_RESID(RESID_P,1), IER) 
	 NORMSloc = RESID(RESID_P,1)/DEN
      ENDIF
      CALL CALC_RESID_PP (B_M, NORMSloc, NUM_RESID(RESID_P,1), &
         DEN_RESID(RESID_P,1), RESID(RESID_P,1), MAX_RESID(RESID_P,1), &
         IJK_RESID(RESID_P,1), IER) 
