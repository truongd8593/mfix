...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
      ...
      USE discretelement, only: DES_CONVERT_BOX_TO_FACETS, STL_FACET_TYPE, &
           ...
           & COUNT_FACET_TYPE_NORMAL, COUNT_FACET_TYPE_MI, COUNT_FACET_TYPE_PO, IS_AUTOGENERATED
...
! contaminate the Eulerian-Eulerian CG stuff
      ...
      IS_AUTOGENERATED(1:N_FACETS) = .FALSE.
...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
      ...
      USE param
      USE stl
      USE discretelement, only: STL_Facet_type, IS_AUTOGENERATED
      ...
      Allocate(is_autogenerated(DIM_STL))
...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
      ...
      use discretelement, only: stl_facet_type, facet_type_normal, facet_type_po, &
           & facet_type_mi, IS_AUTOGENERATED
      use functions
      Implicit None
