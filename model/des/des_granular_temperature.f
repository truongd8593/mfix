...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
      ...
      DOUBLE PRECISION XV(IJKMAX2,100,MMAX)
      DOUBLE PRECISION YV(IJKMAX2,100,MMAX)
      DOUBLE PRECISION ZV(IJKMAX2,100,MMAX) 
      DOUBLE PRECISION AVE_VEL_X(IJKMAX2,MMAX)
      DOUBLE PRECISION AVE_VEL_Y(IJKMAX2,MMAX)
      DOUBLE PRECISION AVE_VEL_Z(IJKMAX2,MMAX), TEMP
