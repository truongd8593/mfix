...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
!
      SUBROUTINE DES_CALC_D_E(A_M, VXF_GS, D_E, IER) 
...
!                 MFIX convention: center coeff is negative
      ...
      ENDIF
      RETURN
      END SUBROUTINE DES_CALC_D_E
!
!
!vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvC
!                                                                      C
!  Module name: DES_CALC_d_n(A_m, VxF_gs, d_n, IER)                    C
!  Purpose: DES - calculte coefficients linking velocity correction to C
...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
!
      SUBROUTINE DES_CALC_D_N(A_M, VXF_GS, D_N, IER)
!...Translated by Pacific-Sierra Research VAST-90 2.06G5  12:17:31  12/09/98
!...Switches: -xf
!
!-----------------------------------------------
...
!                 MFIX convention: center coeff is negative
      ...
      ENDIF
      RETURN
      END SUBROUTINE DES_CALC_D_N
!
!
!vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvC
!                                                                      C
!  Module name: DES_CALC_d_t(A_m, VxF_gs, d_t, IER)                    C
!  Purpose: DES - calculte coefficients linking velocity correction to C
...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
!
      SUBROUTINE DES_CALC_D_T(A_M, VXF_GS, D_T, IER)
!...Translated by Pacific-Sierra Research VAST-90 2.06G5  12:17:31  12/09/98
!...Switches: -xf
!
!-----------------------------------------------
