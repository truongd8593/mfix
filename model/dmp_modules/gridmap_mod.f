...
!-----------------------------------------------
        ...
        if(numPEs.ne.(nodesi*nodesj*nodesk)) then
          ...
          write(*, *) 'nodesi = ', nodesi, '  nodesj = ', nodesj, &
             '  nodesk = ',nodesk
          write(*,*) 'number of processors requested = ', numPEs
          write(*,*) 'nodesi*nodesj*nodesk must equal the ',&
             'number of processors requested in mpirun'
...
!--------------------------------------------------------------------
! Purpose: Initializing all the variables from the information obtained
