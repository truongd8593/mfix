...
$(EXEC_FILE) : \
    ...
    $(DPO)calc_jacobian.$(OBJ_EXT) \
    $(DPO)check_data_chem.$(OBJ_EXT) \
    $(DPO)dgpadm.$(OBJ_EXT) \
    $(DPO)exponential.$(OBJ_EXT) \
    $(DPO)fex.$(OBJ_EXT) \
    $(DPO)g_derivs.$(OBJ_EXT) \
    $(DPO)jac.$(OBJ_EXT) \
    $(DPO)mchem_init.$(OBJ_EXT) \
    $(DPO)mchem_odepack_init.$(OBJ_EXT) \
    $(DPO)mchem_time_march.$(OBJ_EXT) \
    $(DPO)misat_table_init.$(OBJ_EXT) \
    $(DPO)react.$(OBJ_EXT) \
    $(DPO)usrfg.$(OBJ_EXT) \
    $(DPO)add_part_to_link_list.$(OBJ_EXT) \
    $(DPO)calc_app_coh_force.$(OBJ_EXT) \
    $(DPO)calc_cap_coh_force.$(OBJ_EXT) \
    $(DPO)calc_cohesive_forces.$(OBJ_EXT) \
    $(DPO)calc_esc_coh_force.$(OBJ_EXT) \
    $(DPO)calc_square_well.$(OBJ_EXT) \
    $(DPO)calc_van_der_waals.$(OBJ_EXT) \
    $(DPO)check_link.$(OBJ_EXT) \
    $(DPO)check_sw_wall_interaction.$(OBJ_EXT) \
    $(DPO)check_vdw_wall_interaction.$(OBJ_EXT) \
    $(DPO)initialize_cohesion_parameters.$(OBJ_EXT) \
    $(DPO)initialize_coh_int_search.$(OBJ_EXT) \
    $(DPO)linked_interaction_eval.$(OBJ_EXT) \
    $(DPO)remove_part_from_link_list.$(OBJ_EXT) \
    $(DPO)unlinked_interaction_eval.$(OBJ_EXT) \
    $(DPO)update_search_grids.$(OBJ_EXT) \
    $(DPO)calc_force_des_cutcell.$(OBJ_EXT) \
    $(DPO)calc_force_des.$(OBJ_EXT) \
    $(DPO)calc_rrate_des.$(OBJ_EXT) \
    $(DPO)calc_thermo_des.$(OBJ_EXT) \
    $(DPO)cell_near_wall.$(OBJ_EXT) \
...
$(DPO)MCHEM.mod : ./chem/mchem_mod.f \
            $(DPO)PARAM.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/mchem_mod.f  -o $(DPO)mchem_mod.$(OBJ_EXT) -module $(DPO)
...
$(DPO)calc_jacobian.$(OBJ_EXT) : ./chem/calc_jacobian.f \
            $(DPO)PARAM1.mod \
            $(DPO)MCHEM.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/calc_jacobian.f  -o $(DPO)calc_jacobian.$(OBJ_EXT) -module $(DPO)
$(DPO)check_data_chem.$(OBJ_EXT) : ./chem/check_data_chem.f \
            $(DPO)PARAM1.mod \
            $(DPO)RUN.mod \
            $(DPO)MPI_UTILITY.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/check_data_chem.f  -o $(DPO)check_data_chem.$(OBJ_EXT) -module $(DPO)
$(DPO)dgpadm.$(OBJ_EXT) : ./chem/dgpadm.f 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/dgpadm.f  -o $(DPO)dgpadm.$(OBJ_EXT) -module $(DPO)
$(DPO)exponential.$(OBJ_EXT) : ./chem/exponential.f 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/exponential.f  -o $(DPO)exponential.$(OBJ_EXT) -module $(DPO)
$(DPO)fex.$(OBJ_EXT) : ./chem/fex.f \
            $(DPO)RUN.mod \
            $(DPO)PHYSPROP.mod \
            $(DPO)TOLERANC.mod \
            $(DPO)USR.mod \
            $(DPO)MCHEM.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/fex.f  -o $(DPO)fex.$(OBJ_EXT) -module $(DPO)
$(DPO)g_derivs.$(OBJ_EXT) : ./chem/g_derivs.f 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/g_derivs.f  -o $(DPO)g_derivs.$(OBJ_EXT) -module $(DPO)
$(DPO)jac.$(OBJ_EXT) : ./chem/jac.f \
            $(DPO)RUN.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/jac.f  -o $(DPO)jac.$(OBJ_EXT) -module $(DPO)
$(DPO)mchem_init.$(OBJ_EXT) : ./chem/mchem_init.f \
            $(DPO)PARAM1.mod \
            $(DPO)RUN.mod \
            $(DPO)PHYSPROP.mod \
            $(DPO)MCHEM.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/mchem_init.f  -o $(DPO)mchem_init.$(OBJ_EXT) -module $(DPO)
$(DPO)mchem_odepack_init.$(OBJ_EXT) : ./chem/mchem_odepack_init.f \
            $(DPO)MCHEM.mod \
            $(DPO)RUN.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/mchem_odepack_init.f  -o $(DPO)mchem_odepack_init.$(OBJ_EXT) -module $(DPO)
$(DPO)mchem_time_march.$(OBJ_EXT) : ./chem/mchem_time_march.f \
            $(DPO)RUN.mod \
            $(DPO)PHYSPROP.mod \
            $(DPO)FLDVAR.mod \
            $(DPO)RXNS.mod \
            ...
            function.inc                                                 \
            ep_s2.inc                                                   
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/mchem_time_march.f  -o $(DPO)mchem_time_march.$(OBJ_EXT) -module $(DPO)
$(DPO)misat_table_init.$(OBJ_EXT) : ./chem/misat_table_init.f \
            $(DPO)MCHEM.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/misat_table_init.f  -o $(DPO)misat_table_init.$(OBJ_EXT) -module $(DPO)
$(DPO)react.$(OBJ_EXT) : ./chem/react.f \
            $(DPO)PARAM1.mod \
            $(DPO)TOLERANC.mod \
            $(DPO)FLDVAR.mod \
            $(DPO)PHYSPROP.mod \
            ...
            $(DPO)RUN.mod \
            $(DPO)MCHEM.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/react.f  -o $(DPO)react.$(OBJ_EXT) -module $(DPO)
$(DPO)usrfg.$(OBJ_EXT) : ./chem/usrfg.f \
            $(DPO)PARAM1.mod \
            $(DPO)RUN.mod \
            $(DPO)MCHEM.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./chem/usrfg.f  -o $(DPO)usrfg.$(OBJ_EXT) -module $(DPO)
$(DPO)add_part_to_link_list.$(OBJ_EXT) : ./cohesion/add_part_to_link_list.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/add_part_to_link_list.f  -o $(DPO)add_part_to_link_list.$(OBJ_EXT) -module $(DPO)
$(DPO)calc_app_coh_force.$(OBJ_EXT) : ./cohesion/calc_app_coh_force.f \
            $(DPO)DISCRETELEMENT.mod \
            $(DPO)RUN.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/calc_app_coh_force.f  -o $(DPO)calc_app_coh_force.$(OBJ_EXT) -module $(DPO)
$(DPO)calc_cap_coh_force.$(OBJ_EXT) : ./cohesion/calc_cap_coh_force.f \
            $(DPO)DISCRETELEMENT.mod \
            $(DPO)RUN.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/calc_cap_coh_force.f  -o $(DPO)calc_cap_coh_force.$(OBJ_EXT) -module $(DPO)
$(DPO)calc_cohesive_forces.$(OBJ_EXT) : ./cohesion/calc_cohesive_forces.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/calc_cohesive_forces.f  -o $(DPO)calc_cohesive_forces.$(OBJ_EXT) -module $(DPO)
$(DPO)calc_esc_coh_force.$(OBJ_EXT) : ./cohesion/calc_esc_coh_force.f \
            $(DPO)DISCRETELEMENT.mod \
            $(DPO)RUN.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/calc_esc_coh_force.f  -o $(DPO)calc_esc_coh_force.$(OBJ_EXT) -module $(DPO)
$(DPO)calc_square_well.$(OBJ_EXT) : ./cohesion/calc_square_well.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/calc_square_well.f  -o $(DPO)calc_square_well.$(OBJ_EXT) -module $(DPO)
$(DPO)calc_van_der_waals.$(OBJ_EXT) : ./cohesion/calc_van_der_waals.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/calc_van_der_waals.f  -o $(DPO)calc_van_der_waals.$(OBJ_EXT) -module $(DPO)
$(DPO)check_link.$(OBJ_EXT) : ./cohesion/check_link.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/check_link.f  -o $(DPO)check_link.$(OBJ_EXT) -module $(DPO)
$(DPO)check_sw_wall_interaction.$(OBJ_EXT) : ./cohesion/check_sw_wall_interaction.f \
            $(DPO)PARAM1.mod \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/check_sw_wall_interaction.f  -o $(DPO)check_sw_wall_interaction.$(OBJ_EXT) -module $(DPO)
$(DPO)check_vdw_wall_interaction.$(OBJ_EXT) : ./cohesion/check_vdw_wall_interaction.f \
            $(DPO)PARAM1.mod \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/check_vdw_wall_interaction.f  -o $(DPO)check_vdw_wall_interaction.$(OBJ_EXT) -module $(DPO)
$(DPO)initialize_cohesion_parameters.$(OBJ_EXT) : ./cohesion/initialize_cohesion_parameters.f \
            $(DPO)CONSTANT.mod \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/initialize_cohesion_parameters.f  -o $(DPO)initialize_cohesion_parameters.$(OBJ_EXT) -module $(DPO)
$(DPO)initialize_coh_int_search.$(OBJ_EXT) : ./cohesion/initialize_coh_int_search.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/initialize_coh_int_search.f  -o $(DPO)initialize_coh_int_search.$(OBJ_EXT) -module $(DPO)
$(DPO)linked_interaction_eval.$(OBJ_EXT) : ./cohesion/linked_interaction_eval.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/linked_interaction_eval.f  -o $(DPO)linked_interaction_eval.$(OBJ_EXT) -module $(DPO)
$(DPO)remove_part_from_link_list.$(OBJ_EXT) : ./cohesion/remove_part_from_link_list.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/remove_part_from_link_list.f  -o $(DPO)remove_part_from_link_list.$(OBJ_EXT) -module $(DPO)
$(DPO)unlinked_interaction_eval.$(OBJ_EXT) : ./cohesion/unlinked_interaction_eval.f \
            $(DPO)DISCRETELEMENT.mod \
            $(DPO)RUN.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/unlinked_interaction_eval.f  -o $(DPO)unlinked_interaction_eval.$(OBJ_EXT) -module $(DPO)
$(DPO)update_search_grids.$(OBJ_EXT) : ./cohesion/update_search_grids.f \
            $(DPO)DISCRETELEMENT.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./cohesion/update_search_grids.f  -o $(DPO)update_search_grids.$(OBJ_EXT) -module $(DPO)
...
$(DPO)cell_near_wall.$(OBJ_EXT) : ./des/cell_near_wall.f \
            $(DPO)DISCRETELEMENT.mod \
            $(DPO)PARAM.mod \
            $(DPO)PARAM1.mod \
            $(DPO)PARALLEL.mod \
            ...
            $(DPO)BC.mod \
            function.inc                                                
	$(FORTRAN_CMD) $(FORT_FLAGS) ./des/cell_near_wall.f  -o $(DPO)cell_near_wall.$(OBJ_EXT) -module $(DPO)
...
$(DPO)octree.$(OBJ_EXT) : ./des/octree.f \
            $(DPO)RUN.mod \
            $(DPO)PARAM1.mod \
            $(DPO)CONSTANT.mod \
            $(DPO)DISCRETELEMENT.mod \
            ...
            $(DPO)DRAG.mod \
            $(DPO)COMPAR.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./des/octree.f  -o $(DPO)octree.$(OBJ_EXT) -module $(DPO)
...
$(DPO)quadtree.$(OBJ_EXT) : ./des/quadtree.f \
            $(DPO)RUN.mod \
            $(DPO)PARAM1.mod \
            $(DPO)CONSTANT.mod \
            $(DPO)DISCRETELEMENT.mod \
            ...
            $(DPO)DRAG.mod \
            $(DPO)COMPAR.mod 
	$(FORTRAN_CMD) $(FORT_FLAGS) ./des/quadtree.f  -o $(DPO)quadtree.$(OBJ_EXT) -module $(DPO)
