...
! Flags for the scalar grid.
      ...
      if (allocated(FLAG3)) deallocate(FLAG3); allocate( FLAG3 (DIMENSION_4))
      IF(IER /= 0) goto 500
...
! ALLOC increment arrays and report an allocation errors.
      if (allocated(I3_OF)) deallocate(I3_OF); allocate( I3_OF (DIMENSION_4)   )
      if (allocated(J3_OF)) deallocate(J3_OF); allocate( J3_OF (DIMENSION_4)   )
      if (allocated(K3_OF)) deallocate(K3_OF); allocate( K3_OF (DIMENSION_4)   )
      IF(IER /= 0) goto 500

      if (allocated(Im1_3)) deallocate(Im1_3); allocate( Im1_3 (-1:DIMENSION_I+1)   )
      if (allocated(Ip1_3)) deallocate(Ip1_3); allocate( Ip1_3 (-1:DIMENSION_I+1)   )
      IF(IER /= 0) goto 500

      if (allocated(Jm1_3)) deallocate(Jm1_3); allocate( Jm1_3 (-1:DIMENSION_J+1)   )
      if (allocated(Jp1_3)) deallocate(Jp1_3); allocate( Jp1_3 (-1:DIMENSION_J+1)   )
      IF(IER /= 0) goto 500

      if (allocated(Km1_3)) deallocate(Km1_3); allocate( Km1_3 (-1:DIMENSION_K+1)   )
      if (allocated(Kp1_3)) deallocate(Kp1_3); allocate( Kp1_3 (-1:DIMENSION_K+1)   )
      IF(IER /= 0) goto 500

      if (allocated(CELL_CLASS3)) deallocate(CELL_CLASS3); allocate( CELL_CLASS3 (DIMENSION_4)   )
      IF(IER /= 0) goto 500
