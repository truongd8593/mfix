...
! East face (i+1/2, j, k)
            ...
            ELSE 
               ...
               A_M(IJK,0,0) = A_M(IJK,0,0) + (ROP_S(IJK,M)*&
                  E_E(IJK)*K_P+RO_S(M)*U_S(IJK,M))*AYZ(IJK) 
...
! West face (i-1/2, j, k)
            ...
            ELSE 
               ...
               A_M(IJK,0,0) = A_M(IJK,0,0) + (ROP_S(IJK,M)*&
                  E_E(IMJK)*K_P-RO_S(M)*U_S(IMJK,M))*AYZ(IMJK) 
...
! North face (i, j+1/2, k)
            ...
            ELSE 
               ...
               A_M(IJK,0,0) = A_M(IJK,0,0) + (ROP_S(IJK,M)*&
                  E_N(IJK)*K_P+RO_S(M)*V_S(IJK,M))*AXZ(IJK)
...
! South face (i, j-1/2, k)
            ...
            ELSE 
               ...
               A_M(IJK,0,0) = A_M(IJK,0,0) + (ROP_S(IJK,M)*&
                  E_N(IJMK)*K_P-RO_S(M)*V_S(IJMK,M))*AXZ(IJMK) 
...
! Top face (i, j, k+1/2)
               ...
               ELSE 
                  ...
                  A_M(IJK,0,0) = A_M(IJK,0,0) + (ROP_S(IJK,M)*&
                     E_T(IJK)*K_P+RO_S(M)*W_S(IJK,M))*AXY(IJK) 
...
! Bottom face (i, j, k-1/2)
               ...
               ELSE 
                  ...
                  A_M(IJK,0,0) = A_M(IJK,0,0) + (ROP_S(IJK,M)*&
                     E_T(IJKM)*K_P-RO_S(M)*W_S(IJKM,M))*AXY(IJKM) 
