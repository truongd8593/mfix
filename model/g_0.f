...
!
        IF(MMAX > 1) THEN
!
               IF (RDF_TYPE_ENUM .EQ. LEBOWITZ) THEN
!
! Start Lebowitz (1964)
...
! End Lebowitz (1964)
!
               ELSEIF (RDF_TYPE_ENUM .EQ. MODIFIED_LEBOWITZ) THEN
...
!
               ELSEIF (RDF_TYPE_ENUM .EQ. MANSOORI) THEN
!
...
!
               ELSEIF (RDF_TYPE_ENUM .EQ. MODIFIED_MANSOORI) THEN
!
