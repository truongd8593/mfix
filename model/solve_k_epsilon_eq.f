...
!                      temporary variables in residual computation 
      DOUBLE PRECISION res1, mres1, OHMEGA_P, OHMEGA_C
      INTEGER          ires1 
! 
!                      Indices 
...
!
! Under-relaxation factors Ohmega for K & Epsilon source terms. The code runs
! fine without relaxing source terms. They are set equal to one and expert users
! may change these values (less than one) to investigate convergence problems.
!    
      OHMEGA_P = ONE
      OHMEGA_C = ONE
! 
