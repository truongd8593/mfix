...
!                          bcast_0d, bcast_1d, bcast_2d, bcast_3d
      ...
      subroutine prnfield_1d (gbuf,varname,flag1)       
      double precision, intent(in), dimension(:) :: gbuf
      character(len=3), intent(in)   :: flag1
...
!      integer, optional, intent(in) :: mroot, idebug
      ...
      include 'function.inc'
       ...
       OPEN(unit=ldbg,file=flag1//fbname//'.LOG',status='UNKNOWN')
      ...
      subroutine prnfield_1r (gbuf,varname,flag1)       
...
!      integer, optional, intent(in) :: mroot, idebug
      ...
      subroutine prnfield_2d (gbuf,varname,flag1)       
      double precision, intent(in), dimension(:,:) :: gbuf
      character(len=3), intent(in)   :: flag1
      character(len=*), intent(in)   :: varname
      integer :: ldbg = 35
