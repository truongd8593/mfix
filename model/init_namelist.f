...
!<keyword category="Run Control" required="false">
!  <description>
!    MFIX checks for messages generated by the GUI during runtime.
!  </description>
...
!<keyword category="Run Control" required="false">
!  <description>
!    Defines when to interupt a simulation because the time-step has
!    been reduced too frequently. This is only applicable when running
!    in INTERACTIVE_MODE. By default, a simulation is intrupted when
!    3 of the past 5 time-steps resulted in a reduced time step size.
!    o IDX=1: Number of observed time-step reductions [3].
!    o IDX=2: Size of observation window (time-steps) [5].
!  <arg index="1" id="IDX" min="1" max="2"/>
!  </description>
      TIMESTEP_FAIL_RATE(1) = 3
      TIMESTEP_FAIL_RATE(2) = 5
!</keyword>
