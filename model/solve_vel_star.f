...
! temporary velocity arrays 
      DOUBLE PRECISION :: U_gtmp(DIMENSION_3),  V_gtmp(DIMENSION_3), &
                          W_gtmp(DIMENSION_3)
      DOUBLE PRECISION :: U_stmp(DIMENSION_3, DIMENSION_M), &
                          V_stmp(DIMENSION_3, DIMENSION_M), &
                          W_stmp(DIMENSION_3, DIMENSION_M)
