...
!
      ...
      IF(IM1(I).NE.UNDEFINED_I) THEN
        TRUE_CORNER_1 = (FLOW_AT(BOUND_FUNIJK(I,JM1(J),K)).OR.&
           FLOW_AT(BOUND_FUNIJK(I,J,KM1(K))))
        TRUE_CORNER_2 = (FLOW_AT(BOUND_FUNIJK(I,JP1(J),K)).OR.&
           FLOW_AT(BOUND_FUNIJK(I,J,KP1(K))))
...
!
      ...
      IF(JM1(J).NE.UNDEFINED_I) THEN
        TRUE_CORNER_1 = (FLOW_AT(BOUND_FUNIJK(IM1(I),J,K)).OR.&
           FLOW_AT(BOUND_FUNIJK(I,J,KM1(K))))
        TRUE_CORNER_2 = (FLOW_AT(BOUND_FUNIJK(IP1(I),J,K)).OR.&
           FLOW_AT(BOUND_FUNIJK(I,J,KP1(K))))
        TRUE_CORNER = TRUE_CORNER_1.OR.TRUE_CORNER_2
...
!
      ...
      IF(KM1(K).NE.UNDEFINED_I) THEN
        TRUE_CORNER_1 = (FLOW_AT(BOUND_FUNIJK(IM1(I),J,K)).OR.&
           FLOW_AT(BOUND_FUNIJK(I,JM1(J),K)))
        TRUE_CORNER_2 = (FLOW_AT(BOUND_FUNIJK(IP1(I),J,K)).OR.&
           FLOW_AT(BOUND_FUNIJK(I,JP1(K),K)))
        TRUE_CORNER = TRUE_CORNER_1.OR.TRUE_CORNER_2
