...
! Domain partitions in various directions.
      use geometry, only: IMAX, IMAX1, IMIN1, NO_I, DX, XLENGTH, XMIN
      use geometry, only: JMAX, JMAX1, JMIN1, NO_J, DY, YLENGTH
      use geometry, only: KMAX, KMAX1, KMIN1, NO_K, DZ, ZLENGTH
