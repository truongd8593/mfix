...
!* psd                          2001-12-20 21:55Z                      *
!* fft                          2001-12-20 22:00Z                      *
...
!* Date => 2001-03-22                                                  *
!* Last modified => 2001-12-20 21:55Z                                  *
!***********************************************************************
!* Programmer => C.E.A. Finney (Oak Ridge National Laboratory)         *
!* Contact information (as of 2001-11-02) :                            *
!*   Email => <mfix@ceafinney.com>                                     *
!*   Telephone => 865-946-1243                                         *
!*   Post => National Transportation Research Center                   *
!*           2360 Cherahala Boulevard                                  *
...
! !!! Calling program should verify that TS is long enough for nb*n. !!!
      ...
      if (ol.lt.0.) then
       ol = 0.
       write(*,*) 'ornl.psd: ol < 0; set to 0.'
      endif
      if (ol.gt.10.) then
       write(*,*) 'ornl.psd: ol > 10.  WARNING: biased results ?'
      endif
      if (ol.gt.99.) then
       ol = 10.
       write(*,*) 'ornl.psd: ol > 99; set to 10.'
      endif
      nol = int(ol / 100. * n)
      if (hng.lt.0) then
       hng = 4
